...
class IntentRouterPrincipalAgent(ChatCompletionAgent, CustomAgent):
    ...
    def __init__(self, name: str, description: str, agent_list: List[str], conversation_store: ConversationStateStore, conversation_id: str):
        ...
        super().__init__(
            ...
            5. Return Results in Plain Text: Always return the result as plain text, formatted as a raw Python dictionary or JSON object. Avoid using markdown, code blocks, or any other formatting.  
            ...
            If the query is an adaptive card response, set agent_id to the agent who served the previous request and is capable of handling adaptive cards.
            ...
            {{  
                ...
                "your_response": "Can you help me with my last three transactions?"  
            }}  
